...
Локальный Node.js-инструмент для банов карт Warcraft 3: с отдельной админка `/admin`, прозрачным OBS overlay `/overlay`, серверное состояние и синхронизация через Socket.IO.
